    ...
    def verify_integrity(self) -> Dict[str, Any]:
        ...
        for i, entry in enumerate(self.entries):
            ...
            if computed_hash != entry.hash:
                logger.error(f"Hash mismatch at entry {i}: {computed_hash} != {entry.hash}")
                return {
                    "valid": False,
